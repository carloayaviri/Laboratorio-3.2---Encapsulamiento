        ...
        switch (opcion) {
            ...
            case 4:
             ...
             case 5:
                ...
                System.out.println("+==================================================+");
                System.out.print("Introduzca el valor del lado: ");
                pentagono.setLado(entradaTeclado.nextDouble());
                System.out.println("El Area del Cuadrado es: " + pentagono.getArea());
                System.out.println("El Perimetro del Cuadrado es: " + pentagono.getPerimetro());
                break;
            case 6:
                limpiarConsola();
                System.out.println("+==================================================+");
                ...
                System.out.print("Introduzca el valor de la Altura: ");
                double haltura = entradaTeclado.nextDouble();
                Trapecio trapecio = new Trapecio(basemayor,basemenor, haltura);
